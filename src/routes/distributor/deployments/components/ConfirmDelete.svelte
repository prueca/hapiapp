...
{#if state.pendingDelete}
    ...
    >
       <div class="modal-box">
            <div class="heading">
                 <p class="mb-4 text-lg font-bold">Delete Deployment</p>
            </div>
        ...
        {:else}
                 <p class="message">
                      Are you sure you want to delete this deployment and its items? The freezer
                      records are kept.
                 </p>
        {/if}

            <div class="modal-action">
                 <button class="close-btn btn" onclick={() => state.cancelDelete()}>
                    Cancel
                 </button>
                 <button
                    class="btn btn-error"
